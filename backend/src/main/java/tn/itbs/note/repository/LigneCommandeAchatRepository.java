...
public interface LigneCommandeAchatRepository extends JpaRepository<LigneCommandeAchat, Long> {
    ...
    /**
     * Find all line items for a specific supplier.
     */
    @Query("SELECT l FROM LigneCommandeAchat l WHERE l.commande.fournisseur.id = :fournisseurId ORDER BY l.createdAt DESC")
